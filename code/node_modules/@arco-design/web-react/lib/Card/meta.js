...
function Meta(props, ref) {
    ...
    return (react_1.default.createElement("div", __assign({}, others, { ref: ref, className: classNames }),
        title || description ? (react_1.default.createElement("div", { className: prefixCls + "-content" },
            title && react_1.default.createElement("div", { className: prefixCls + "-title" }, title),
            description && react_1.default.createElement("div", { className: prefixCls + "-description" }, description))) : null,
        avatar || actionList ? (react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-footer ", (_a = {}, _a[prefixCls + "-footer-only-actions"] = !avatar, _a)) },
            avatar ? react_1.default.createElement("div", { className: prefixCls + "-avatar" }, avatar) : null,
            actionList)) : null));
}
