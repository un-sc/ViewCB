...
function WeekPicker(props) {
    ...
    var weekStart = (0, react_1.useContext)(context_1.default).weekStart;
    ...
    function isSameTime(current, target) {
        return dayjs_1.methods.isSameWeek(current, target, weekStart, localeName);
    }
    return (react_1.default.createElement(date_1.default, __assign({}, rest, bodyProps, headerOperations, { isWeek: true, isSameTime: isSameTime, isRangePicker: isRangePicker })));
}
