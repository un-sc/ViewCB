...
function TabPane(props, ref) {
    var shouldRender = (0, react_1.useRef)(false);
    ...
    return (shouldRender.current && (react_1.default.createElement("div", __assign({ ref: ref }, (0, omit_1.default)(rest, ['destroyOnHide', 'title', 'closable']), { className: (0, classNames_1.default)(prefixCls + "-pane", className), style: style }), children)));
}
var TabPaneRef = react_1.default.forwardRef(TabPane);
TabPaneRef.displayName = 'TabPane';
TabPaneRef.isTabPane = true;
exports.default = TabPaneRef;
