...
function useRowSelection(props, pageData, data, getRowKey) {
            ...
            if ((0, is_1.isArray)(children) && children.length) {
                children.forEach(function (record) {
                    ...
                    var checkboxProps = rowSelection && typeof rowSelection.checkboxProps === 'function'
                        ? rowSelection.checkboxProps((0, utils_1.getOriginData)(record))
                        : {};
    ...
    var _b = __read((0, react_1.useState)([]), 2), selectedRowKeys = _b[0], setSelectedRowKeys = _b[1];
    var _c = __read((0, react_1.useState)([]), 2), indeterminateKeys = _c[0], setIndeterminateKeys = _c[1];
    var keys = (0, utils_1.getSelectedKeysByData)(flattenData, getSet(controlledSelectedRowKeys || selectedRowKeys), getRowKey, childrenColumnName, checkConnected);
    ...
    var _d = __read((0, react_1.useState)(pureKeys ? [] : getRowsFromKeys(mergedSelectedRowKeys)), 2), selectedRows = _d[0], setSelectedRows = _d[1];
    ...
    function onCheckAll(checked) {
        ...
        var originSelectedRows = (0, utils_1.getOriginData)(newSelectedRows);
    ...
    function onCheck(checked, record) {
        var _a = (0, utils_1.getSelectedKeys)(record, checked, mergedSelectedRowKeys, indeterminateKeys, getRowKey, childrenColumnName, checkConnected), selectedRowKeys = _a.selectedRowKeys, _indeterminateKeys = _a.indeterminateKeys;
        ...
        onSelect && onSelect(checked, (0, utils_1.getOriginData)(record), originSelectedRows);
        onChange && onChange(newSelectedRowKeys, originSelectedRows);
    }
    function onCheckRadio(key, record) {
        ...
        onSelect && onSelect(true, (0, utils_1.getOriginData)(record), originSelectedRows);
