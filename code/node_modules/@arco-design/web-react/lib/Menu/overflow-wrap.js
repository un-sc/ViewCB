...
var OverflowWrap = function (props) {
    ...
    var renderOverflowSubMenu = function (children, isMirror) {
        ...
        return (react_1.default.createElement(sub_menu_1.default, __assign({ title: react_1.default.createElement("span", null, ellipsisText), key: "arco-menu-overflow-sub-menu" + (isMirror ? '-mirror' : ''), className: isMirror ? overflowSubMenuMirrorClass : overflowSubMenuClass }, props, { children: children })));
    };
