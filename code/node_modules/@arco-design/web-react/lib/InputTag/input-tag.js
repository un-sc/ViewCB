...
function InputTag(baseProps, ref) {
    ...
    var mergedRenderTag = function (item, index) {
        ...
        return (react_1.default.createElement(Tag_1.default, { visible: true, className: (0, classNames_1.default)(prefixCls + "-tag", (_a = {},
                ...
                _a)), closable: closable, closeIcon: icon && icon.removeIcon, title: typeof label === 'string' ? label : undefined, onClose: onClose }, (0, fillNBSP_1.default)(label)));
    };
    var handleTokenSeparators = function (str) {
        var hasSeparator = false;
        if ((0, is_1.isArray)(tokenSeparators) && tokenSeparators.length) {
    ...
    return (react_1.default.createElement("div", __assign({}, (0, omit_1.default)(rest, ['size', 'defaultValue', 'value', 'inputValue']), { style: style, className: (0, classNames_1.default)(prefixCls, (_a = {},
