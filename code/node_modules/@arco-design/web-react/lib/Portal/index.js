...
var PortalWrapper = /** @class */ (function (_super) {
    ...
    PortalWrapper.prototype.render = function () {
        ...
        return forceRender || visible || this.instance ? (react_1.default.createElement(Portal_1.default, __assign({ ref: function (ref) { return (_this.instance = ref); } }, this.props))) : null;
    };
