...
export default function JavaScriptList() {
    return (
        <>
            ...
            <Script src="https://unsc.oss-accelerate.aliyuncs.com/ViewCB/JavaScript/theme.js" strategy="beforeInteractive" />
            <Script src="https://unsc.oss-cn-hongkong.aliyuncs.com/ViewCB/JavaScript/echarts.min.js" strategy="beforeInteractive" />
        </>
    )
}