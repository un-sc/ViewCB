        ...
        <>
            ...
            <div className='row gy-5'>
                <div className='col-12'>
                    ...
                    <p className="lead">如果您发现本站的内容存在问题，欢迎您将指正意见发送至本人的邮箱：<Link href='mailto: 2779799659@qq.com'><a>2779799659@qq.com</a></Link></p>
                    <h3>关于本站的文字编撰方法</h3>
                    <p className='lead'>本站使用了<Link href="https://github.com/remarkjs/remark">remark</Link>库，以此来实现将markdown文件转化为html可识别内容。本站的命令详解部分内容均使用了该方法，因此文档的源文件为markdown文件。</p>
